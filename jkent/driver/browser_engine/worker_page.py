...
from jkent.driver.database_engine.sql_manager import IncidentalRequestParams
...
class WorkerPage(WorkerHandle):
    ...
    def __init__(
        ...
        self.page = page
        self.incidental_requests: list[IncidentalRequestParams] = []
    ...
    def _register_network_listeners(self) -> None:
        ...
        def on_request(request: Any) -> None:
            ...
            try:
                ...
                post_body = None
            incidental: IncidentalRequestParams = {
